...
const HotelReg = () => {
  ...
  return (
    <div onClick={()=>setShowHotelReg(false)} className='fixed top-0 botton-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70 h-screen'>

        <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2 text-gray-700' onSubmit={onSubmitHandler} onClick={(e)=>{e.stopPropagation()}}>
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                ...
                <p className='text-2xl font-semibold mt-6 text-gray-600'>Register Your Hotel </p>
                ...
                <div  className='w-full mt-4 max-w-60 mr-auto'>
                    ...
                    <select onChange={(e)=>setCity(e.target.value)} value={city}id="city" className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-none font-light text-black/60' required>
